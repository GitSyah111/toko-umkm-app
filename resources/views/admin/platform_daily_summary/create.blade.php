<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Create Platform Daily Summary') }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('admin.platform-summary.store') }}">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="total_gmv" class="block mt-1 w-full" type="number" step="0.01" name="total_gmv" :value="old('total_gmv', 0)" required />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="total_active_tokos" class="block mt-1 w-full" type="number" name="total_active_tokos" :value="old('total_active_tokos', 0)" required />
