    ...
    public function run(): void
    {
        ...
        foreach ($elektronik as $nama) {
            ...
            $produks[] = [
                ...
                'berat' => rand(100, 2000),
                'stok' => rand(10, 100),
                'gambar' => 'https://picsum.photos/seed/elektronik' . $idCounter . '/400/400',
                'status' => 'aktif',
                'created_at' => $now,
                'updated_at' => $now,
            ];
        ...
        foreach ($fashion as $nama) {
            ...
            $produks[] = [
                ...
                'berat' => rand(200, 800),
                'stok' => rand(20, 200),
                'gambar' => 'https://picsum.photos/seed/fashion' . $idCounter . '/400/400',
                'status' => 'aktif',
                'created_at' => $now,
                'updated_at' => $now,
            ];
        ...
        foreach ($kuliner as $nama) {
            ...
            $produks[] = [
                ...
                'berat' => rand(100, 500),
                'stok' => rand(30, 300),
                'gambar' => 'https://picsum.photos/seed/kuliner' . $idCounter . '/400/400',
                'status' => 'aktif',
                'created_at' => $now,
                'updated_at' => $now,
            ];
